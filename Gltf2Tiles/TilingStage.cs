...
public static partial class StagesFacade
{
        ...
        GpsCoords? coords = null)
    {
        ...
        ConvertGltf2B3dm(sourcePath, destPath, lods);
    ...
    private static void ConvertGltf2B3dm(string sourcePath, string destPath, int lods)
    {
        var filesToConvert = new List<Tuple<string, string>>();

        for (var lod = 0; lod < lods; lod++)
        {
            var files = Directory.GetFiles(Path.Combine(sourcePath, "LOD-" + lod), "*.gltf");
            ...
            foreach (var file in files)
            {
                ...
                Utils.ConvertGltf2B3dm(file, outputFile);
            }
        }
        ...
        //    Utils.ConvertGltf2B3dm(file.Item1, file.Item2);
        //});
    }
    // Where is it?
